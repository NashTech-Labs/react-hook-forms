...
import { getFilters, updateFilters } from '../../../store/feature/filters/filtersSlice'
import { statusOptions , dealTypeOptions } from '../../../constants/FormOptions'
...
const FilterModal = ({ closeModal }: IFilterModal) => {
    ...
    <Box p={1} data-testid="deleteDealModal" sx={{ padding: 0 }}>
      ...
      <Box my={2}>
        {
            Object.keys(dealTypeOptions).map(key => <Chip
                key={key}
                label={dealTypeOptions[key]}
